        ...
        return (
            <li key={item.id} className="flex flex-col  w-40 min-[400px]:w-44 sm:w-52 md:w-64 m-2 border-2 border-gray-200 rounded-md">
                <Link href={`products/${item.id}`}>
                    ...
                    <h2 className="title-item text-base lg:text-lg mx-1 sm:mx-5 mt-2 flex flex-wrap h-12 overflow-hidden">{item.name}</h2>
                    <p className="font-price text-green-600 text-base ml-1 sm:ml-5 mt-1 lg:mt-2 mb-2">
